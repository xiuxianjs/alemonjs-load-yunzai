...
function MihoyoHelp({ data: _data }) {
    return (React.createElement(HTML, { style: { width: '780px' } },
        React.createElement("div", { className: "p-[15px] bg-yz-bg font-['tttgbnumber',system-ui,sans-serif] text-base text-yz-text" },
            ...
            React.createElement("div", { className: 'bg-yz-card rounded-xl p-4 mb-3.5 shadow-card' },
                React.createElement(Title, { color: 'bg-yz-green' }, "\u53EF\u5B89\u88C5\u63D2\u4EF6"),
                React.createElement("div", { className: 'flex flex-col gap-2' }, PLUGINS.map((p, i) => (React.createElement("div", { key: i, className: 'flex items-center bg-yz-green-bg rounded-lg py-2.5 px-3.5 gap-3' },
                    React.createElement("div", { className: 'text-[13px] font-bold text-yz-green bg-white rounded px-2 py-0.5 whitespace-nowrap min-w-[130px] text-center' }, p.cmd),
                    React.createElement("div", { className: 'flex-1' },
                        React.createElement("span", { className: 'text-[13px] font-bold text-yz-text' }, p.name),
                        React.createElement("span", { className: 'text-xs text-yz-gray ml-2' }, p.desc)),
                    React.createElement("div", { className: 'text-[11px] text-yz-sub whitespace-nowrap' },
                        "\u522B\u540D: ",
                        p.alias)))))),
