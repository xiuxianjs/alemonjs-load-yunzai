            ...
            installed.length > 0 && (React.createElement("div", { className: 'bg-yz-card rounded-xl p-4 mb-3.5 shadow-card' },
                React.createElement("div", { className: 'flex items-center gap-2 mb-2.5' },
                    ...
                    React.createElement("span", { className: 'text-[11px] text-yz-gray ml-1' },
                        ...
                        installed.length,
                        ")")),
                React.createElement("div", { className: 'grid grid-cols-2 gap-2' }, installed.map((p, i) => (React.createElement("div", { key: i, className: 'flex items-center bg-yz-green-bg rounded-lg py-2 px-3 gap-2 border-l-4 border-yz-green' },
            ...
            notInstalled.length > 0 && (React.createElement("div", { className: 'bg-yz-card rounded-xl p-4 mb-3.5 shadow-card' },
                React.createElement("div", { className: 'flex items-center gap-2 mb-2.5' },
                    ...
                    React.createElement("span", { className: 'text-[11px] text-yz-gray ml-1' },
                        ...
                        notInstalled.length,
                        ")")),
                React.createElement("div", { className: 'grid grid-cols-2 gap-2' }, notInstalled.map((p, i) => (React.createElement("div", { key: i, className: 'flex items-center bg-yz-blue-bg rounded-lg py-2 px-3 gap-2' },
                    React.createElement("div", { className: 'text-[12px] font-bold text-yz-blue bg-white rounded px-1.5 py-0.5 whitespace-nowrap min-w-[110px] text-center' }, '#yz安装插件' + p.aliases[0]),
                    React.createElement("div", { className: 'flex-1 min-w-0' },
